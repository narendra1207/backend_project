...
export class UsertypeComponent implements OnInit , OnDestroy {
  ...
  getData() {
    this._commonService
      .get(Global.BASE_API_PATH + 'UserType/GetAll')
      .subscribe((res) => {
        if (res.isSuccess) {
          // debugger
  ...
  Submit() {
    switch (this.dbops) {
      case DBOperation.create:
        this._commonService
          .post(Global.BASE_API_PATH + 'UserType/Save/', this.addForm.value)
          .subscribe((res) => {
            if (res.isSuccess) {
      ...
      case DBOperation.update:
        this._commonService
          .post(Global.BASE_API_PATH + 'UserType/Update/', this.addForm.value)
          .subscribe((res) => {
            if (res.isSuccess) {
              this._toastr.success(
  ...
  Delete(_id: number) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this._commonService
          .post(Global.BASE_API_PATH + 'UserType/Delete/', obj)
          .subscribe((res) => {
            if (res.isSuccess) {
              this.getData();
